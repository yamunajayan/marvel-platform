...
4. Optional: Get Firebase config from Firebase project settings in the Firebase Console.
      Note: If you are using setup option #2, you can skip this step. See the development options below.
